...
const Profile = () => {
  ...
  const badgeStyle = { background: 'rgba(99,102,241,0.1)', color: '#6366f1', padding: '6px 12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 'bold', display: 'inline-block' };
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ color: '#6366f1', marginBottom: '20px', fontSize: '1.5rem' }}>Order History</h3>
      {loading ? (
